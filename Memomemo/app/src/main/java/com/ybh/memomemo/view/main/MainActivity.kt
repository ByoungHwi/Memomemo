package com.ybh.memomemo.view.main
...
import com.ybh.memomemo.view.setting.SettingActivity
import com.ybh.memomemo.view.home.HomeFragment
import com.ybh.memomemo.view.main.presenter.MainContract
import com.ybh.memomemo.view.note.addNote.AddNoteFragment
import com.ybh.memomemo.view.note.editNote.EditNoteFragment
...
class MainActivity : AppCompatActivity(), MainContract.View {
   ...
   fun useAddFragment() {
    ...
    fun saveNote() {
        if(UserData.currentImages.size != 0) {
            UserData.currentNote.thumnail = UserData.currentImages[0].uri
        }else
        {
            UserData.currentNote.thumnail = null
        }
