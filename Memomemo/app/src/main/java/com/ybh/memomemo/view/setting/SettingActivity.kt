package com.ybh.memomemo.view.setting
...
import com.ybh.memomemo.view.password.passwordSetting.PasswordSettingActivity
                ...
                if(newValue as Boolean)
                {
                    ...
                    if(prefs.getString("PASSWORD","NO_PASSWORD") == "NO_PASSWORD")
                    {
                        val intent = Intent(this.context,
                            PasswordSettingActivity::class.java)
